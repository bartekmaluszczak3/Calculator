...
class AdvancedModeActivity :AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonLeftB = findViewById<Button>(R.id.buttonLefB)
        buttonLeftB.setOnClickListener { append("(") }
        val buttonRightB = findViewById<Button>(R.id.buttonRightB)
        buttonRightB.setOnClickListener { append(")") }
        val buttonSin = findViewById<Button>(R.id.buttonSin)
        buttonSin.setOnClickListener { append("sin(") }
        val buttonCos = findViewById<Button>(R.id.buttonCos)
        buttonCos.setOnClickListener { append("cos(") }
        val buttonTan = findViewById<Button>(R.id.buttonTan)
        buttonTan.setOnClickListener { append("tan(") }
        val buttonXY = findViewById<Button>(R.id.buttonXY)
        buttonXY.setOnClickListener { append("^") }
        val buttonLg = findViewById<Button>(R.id.buttonLg)
        buttonLg.setOnClickListener { append("log2(") }
        val buttonLn = findViewById<Button>(R.id.buttonLn)
        buttonLn.setOnClickListener { append("ln(") }
        val buttonSqrt = findViewById<Button>(R.id.buttonSqrt)
        buttonSqrt.setOnClickListener {  append("sqrt(")}
        val buttonX2 = findViewById<Button>(R.id.buttonX2)
        buttonX2.setOnClickListener { append("^2") }
    }
